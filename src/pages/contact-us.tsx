  ...
  return (
    <div>
              ...
              <div className="space-y-5 text-white">
                <p className="flex flex-col items-center text-center gap-1 sm:flex-row sm:items-start sm:text-left sm:gap-3 max-md:gap-5">
                  ...
                  <span className="max-md:w-[200px]">
                    4,Pillyar Kovil Street Velachery, Main Road, Madipakkam,
      ...
      <div className="pb-20 mt-10">
        ...
        <div className="flex flex-wrap justify-evenly items-center">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.1112347576864!2d80.19432387358893!3d12.964733415031823!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525ddd6f6e3257%3A0xf2a3579581540aa9!2s369%20Fitness%20wellness!5e0!3m2!1sen!2sin!4v1728299968126!5m2!1sen!2sin"
            width="1300"
            height="450"
            loading="lazy"
          ></iframe>
...
//                 <button
//                   type="submit"
//                   className="bg-primary text-white px-4 py-2 rounded-md hover:bg-primary/90 transition-all duration-300 w-fit flex flex-row"
//                   disabled={loading}
//                 >
